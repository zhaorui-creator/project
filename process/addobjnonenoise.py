...
if __name__=='__main__':
    ...
    for k in range(0,59):
        ...
        print(len(center_list7))
        #if k<9:
            #source_path='/home/dl/Dataset/augnew11/augnew'+'0'+ str(k+1) + '/'
        #else:
            #source_path='/home/dl/Dataset/augnew11/augnew'+ str(k+1) + '/'
        source_path='/home/dl/Dataset/org/'
        #source_path='/home/dl/result/org/'
        #obj_path='/home/dl/resize/'
        target_path='/home/dl/Dataset/background_and_obj/'
        ...
        #cv2.imwrite(source_path + "normal_merge2.jpg", normal_clone)
            #cv2.imwrite(source_path + "fluid_merge"+str(i)+'.jpg', mixed_clone)
                ...
                cv2.imwrite(target_path + str(k+1)+'/'+'abcd'+str(k+1)+'_and_'+filename+str(j)+'.jpg', mixed_clone)
            #print(len(list))
        list1.clear()